...
2. Выберите модель и тип LoRA: лицо, персонаж, стиль, предмет или общее.
...
- модель получает профильную стратегию для `Лицо`, `Персонаж`, `Стиль`, `Предмет` или `Общее`;
...
- для face/portrait LoRA captions сильнее фокусируются на портретном кадрировании, ракурсе лица, взгляде, выражении, волосах у лица, очках, бороде, макияже, перекрытиях и свете на лице;
